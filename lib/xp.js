...
// XP necessaria per passare dal livello `level` al successivo. Cresce piano:
// 100 per il 1→2 (~25 messaggi), poi +40 a livello.
const xpForNext = (level) => 100 + (Math.max(1, level) - 1) * 40;
