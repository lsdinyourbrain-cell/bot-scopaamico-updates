...
//        antiadd:    true,  // blocca aggiunta membri non autorizzata
//        antikick:   true,  // blocca rimozione membri non autorizzata
//        antibot:    true,  // rimuovi bot in ingresso
//        antivoip:   true,  // rimuovi numeri non-+39 in ingresso
//        antiwb:     true,  // rimuovi account Business in ingresso
//        antifake:   true,  // rimuovi account sospetti in ingresso
//    }
//  }
//  "Ultra sicuro": SOLO owner e whitelist possono fare azioni distruttive
//  (aggiungere/rimuovere membri, promuovere, cambiare impostazioni del
//  gruppo). Gli admin NORMALI vengono bloccati su quelle azioni: chi ha
//  davvero bisogno dei pieni poteri va messo in whitelist.
// ============================================================================
...
const ANTINUKE_CONTROLS = {
    ...
    antiadd   : 'Blocca aggiunta membri non autorizzata',
    antikick  : 'Blocca rimozione membri non autorizzata',
    antibot   : 'Rimuovi bot in ingresso',
    antivoip  : 'Rimuovi numeri non-+39 in ingresso',
    antiwb    : 'Rimuovi account Business in ingresso',
