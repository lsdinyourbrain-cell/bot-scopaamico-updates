    ...
    async run(sock, msg, args, context) {
        ...
        try {
            ...
            if (!media || media.kind === 'video') {
                return reply(`${sec('INFO')}\n${boxOpen()}\n${line('⚠️ _[uso]: rispondi a un\'immagine (o uno sticker) per convertirla in ASCII._')}\n${line(`Uso: \`.ascii\` oppure \`.ascii 60\` — _per la larghezza_.`)}\n${boxEnd()}`);
            }
            ...
            await prog.done(`${sec('ASCII ART')}\n${boxOpen()}\n${line('_ASCII Art pronta!_')}\n${boxEnd()}`);
        } catch (e) {
