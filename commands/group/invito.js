...
module.exports = {
    ...
    async run(sock, msg, args, context) {
        ...
        if (!isSenderAdmin && !isOwner) return reply("⚠️ _[uso]:_ solo gli admin possono ottenere il link del gruppo.");
        if (!isBotAdmin) return reply("⚠️ _[uso]:_ rendimi admin così posso generare il link.");
