...
module.exports = {
    ...
    description: 'Mostra statistiche reali del bot.',

    async run(sock, msg, args, context) {
        const { from, sender, pushName, services } = context;
        const { db, commands, sendButtons } = services;
