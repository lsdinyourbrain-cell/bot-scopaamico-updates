...
const SECTIONS = [
    ...
    },
    {
        ...
        items: [
            ...
            ['👋', 'setwelcome'], ['👋', 'setgoodbye'], ['📜', 'setrules'], ['📋', 'rules'], ['👻', 'hidetag'],
            ['🗳️', 'votekick'], ['⏰', 'tempban'], ['🔇', 'muteall'], ['🔊', 'unmuteall'], ['🧹', 'purge'],
            ['✏️', 'setsubject'], ['ℹ️', 'infogruppo'], ['🔗', 'invitelink'], ['👑', 'adminlist'], ['🟢', 'boton'],
            ['🔴', 'botoff'], ['🔗', 'antilinkstrict'], ['🤖', 'antifake'], ['🌍', 'antiforeign'], ['📵', 'antistatus'],
            ['🖼️', 'mediaonly'], ['💾', 'gbackup'], ['📝', 'notes'], ['📊', 'polladmin'], ['📢', 'announce'],
            ['😀', 'autoreact'], ['🔍', 'chatfilter'], ['🕐', 'bizhours'], ['📜', 'grouplog'], ['📈', 'activity'],
            ['🏆', 'leaderboardadmin'], ['📊', 'chatrank'], ['🤫', 'confessadmin'], ['🔗', 'wordchain'], ['🤖', 'autoresponder'],
            ['👋', 'welcome2'], ['👋', 'goodbye2'], ['🔒', 'restrict'], ['⏳', 'ephemeral2'], ['⬇️', 'demoteall2'],
        ],
    },
    {
